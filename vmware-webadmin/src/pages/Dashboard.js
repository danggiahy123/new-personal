...
const Dashboard = () => {
  ...
  const vmStatusData = [
    { name: 'Running', value: vms.filter(vm => vm.power_state === 'POWERED_ON').length, color: '#10B981' },
    { name: 'Stopped', value: vms.filter(vm => vm.power_state === 'POWERED_OFF').length, color: '#EF4444' },
    { name: 'Suspended', value: vms.filter(vm => vm.power_state === 'SUSPENDED').length, color: '#F59E0B' },
  ];
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-500">Last 24h Activity</span>
              </div>
              <span className="text-sm font-medium text-gray-900">
                {stats?.logs?.recent24h || 0} actions
              </span>
            </div>
